...
list_file = Listbox(list_frame, selectmode="extended", yscrollcommand=scrollbar)
...
btn_dest_path = Button(path_frame, text="찾아보기", width=10, command=browe_dest_file)
...
cmb_width = ttk.Combobox(frame_option, state="readolny", values=opt_width, width=10)
cmb_width.current(0)
...
btn_close = Button(frame_run, text="닫기", width=12, padx=5, pady=5)
